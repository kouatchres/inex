  ...
  function createDivision() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleRegionChange", function (dataSource) {
      ...
      if (dataSource.length > 0) {
        ...
        return selectedRegion; //    this.setState(()=>{return{region:filteredRegion}})
      } else {
  ...
  _createClass(createDivision, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Query"], {
        ...
        console.log('stripping off __typename');
...
//# sourceMappingURL=newDivision.js.4295f7127ae47b36563b.hot-update.js.map