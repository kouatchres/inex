...
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:3px solid ", ";grid-gap:3px;background:", ";height:20px;padding:5px;& > *{background:#357;border:0;font-family:'radnika_next';font-size:1rem;padding:.9rem;}"], function (props) {
  return props.theme.lightGrey;
}, function (props) {
  return props.theme.lightGrey;
});
...
})(["display:flex;flex-direction:column;padding:5px;p{display:flex;flex-direction:column;}"]);
var UpdateBtn = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  ...
  _createClass(Candidate, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ItemStyled, {
        ...
        __self: this
      }, "First Name: ", cand1stName), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 109
        },
        __self: this
      }, "2nd Name: ", cand2ndName), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 110
        },
...
//# sourceMappingURL=candidatePage.js.6ebd9a4e766366b0378b.hot-update.js.map