...
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:1px solid ", ";grid-gap:5px;height:20px;padding:15px;margin-bottom:15px;font-weight:bold;font-size:2.5rem;color:white;"], function (props) {
  return props.theme.lightGrey;
});
...
//# sourceMappingURL=candidatePage.js.a2315ef6b8eeccc5de32.hot-update.js.map