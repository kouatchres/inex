...
})(["display:grid;grid-template-columns:repeat(auto-fit,minmax(11rem,1fr));grid-gap:1rem;"]);
...
})(["text-align:left;padding:0.2rem;margin:.5rem auto;font-size:1.3rem;line-height:0.3rem;min-width:15rem;"]);
...
})(["display:flex;flex-direction:column;margin-bottom:.5rem;img{margin-top:.5rem;margin-left:.5rem;height:15rem;width:15rem;border-radius:0.7rem;background-size:contain;background-position:center;}"]);
...
//# sourceMappingURL=singleCand.js.3c77df3ac3cded388957.hot-update.js.map