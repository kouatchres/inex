...
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:1px solid ", ";grid-gap:5px;height:50;padding:5px;& > *{background:#357;border:0;font-family:'radnika_next';font-size:1.8rem;padding:1.2rem;}"], function (props) {
  return props.theme.lightGrey;
});
...
})(["padding:5px;img{max-width:100%;object-fit:cover;border-radius:12px;height:230px;}"]);
...
})(["background-color:#359;border-radius:5px;font-size:2.2rem;font-weight:normal;color:white;"]);
...
//# sourceMappingURL=candidatePage.js.a1dde0b3e3ed6cb6baaa.hot-update.js.map