...
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:1px solid ", ";grid-gap:5px;height:20px;color:white;font-weight:bold;font-size:2.2rem;background-color:#375;padding:5px;& > *{background:#357;border:0;font-family:'radnika_next';font-size:1.8rem;}"], function (props) {
  return props.theme.lightGrey;
});
...
//# sourceMappingURL=candidatePage.js.c7b8a8509a450e22cd1c.hot-update.js.map