...
})(["background:", ";border:.7px solid ", ";position:relative;display:grid;grid-template-columns:1fr;background-color:white;width:400px;border-radius:7px;height:310px;"], function (props) {
...
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:1px solid ", ";grid-gap:5px;height:20px;padding:5px;justify-items:center;"], function (props) {
  return props.theme.lightGrey;
});
...
//# sourceMappingURL=candidatePage.js.4b8acd14133fb967a5fb.hot-update.js.map