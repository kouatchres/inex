...
})(["background:", ";border:.7px solid ", ";position:relative;display:grid;grid-template-columns:1fr;background-color:white;width:400px;height:250px;"], function (props) {
...
})(["display:grid;grid-template-columns:repeat(2,1fr);height:200px;"]);
...
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:.5px solid ", ";grid-gap:3px;height:50;background:", ";& > *{background:#357;border:0;font-family:'radnika_next';font-size:1rem;padding:.9rem;}"], function (props) {
  return props.theme.lightGrey;
}, function (props) {
  return props.theme.lightGrey;
});
...
})(["width:200px;height:150px;img{max-width:100%;object-fit:cover;border-radius:12px;width:200px;height:250px;}"]);
...
})(["margin:1em,0,0,0;display:flex;flex-direction:row;text-align:left;"]);
...
//# sourceMappingURL=candidatePage.js.529189e128c1eebfe52e.hot-update.js.map