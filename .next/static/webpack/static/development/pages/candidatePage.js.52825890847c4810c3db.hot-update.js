...
})(["background:", ";border:.7px solid ", ";position:relative;display:grid;grid-template-columns:1fr;grid-auto-flow:colum;border-radius:18px;background-color:white;"], function (props) {
...
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:3px solid ", ";grid-gap:3px;background:", ";& > *{background:#357;border:0;font-family:'radnika_next';font-size:1.5rem;padding:.9rem;}"], function (props) {
  return props.theme.lightGrey;
}, function (props) {
  return props.theme.lightGrey;
});
...
//# sourceMappingURL=candidatePage.js.52825890847c4810c3db.hot-update.js.map