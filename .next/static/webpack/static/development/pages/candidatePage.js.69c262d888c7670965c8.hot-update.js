...
})(["background:", ";border:.7px solid ", ";position:relative;display:grid;grid-template-columns:1fr;background-color:white;width:400px;height:400px;"], function (props) {
...
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:.5px solid ", ";grid-gap:3px;background:", ";& > *{background:#357;border:0;font-family:'radnika_next';font-size:1rem;padding:.9rem;}"], function (props) {
  return props.theme.lightGrey;
}, function (props) {
  return props.theme.lightGrey;
});
...
})(["width:200px;height:100px;img{max-width:100%;object-fit:cover;border-radius:12px;}"]);
...
//# sourceMappingURL=candidatePage.js.69c262d888c7670965c8.hot-update.js.map