                      ...
                      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Query"], {
                        ...
                        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Mutation"], {
                          ...
                          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_styles_Form__WEBPACK_IMPORTED_MODULE_3__["default"], {
                            ...
                            __self: this
                          }, "Choisissez un Examen"), exam && exam.map(function (item) {
                            return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("option", {
                              key: item.id,
                              value: item.id,
                              __source: {
                            ...
                            __self: this
                          }, "Choisissez la Session"), session && session.map(function (item) {
                            return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("option", {
                              key: item.id,
                              value: item.id,
                              __source: {
                            ...
                            __self: this
                          }, "Choisissez un Type d'enseignement"), educationTypes && educationTypes.map(function (item) {
                            return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("option", {
                              key: item.id,
                              value: item.id,
                              __source: {
                            ...
                            __self: this
                          }, "Choisissez une Serie"), series && series.map(function (item) {
                            return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("option", {
                              key: item.id,
                              value: item.id,
                              __source: {
...
//# sourceMappingURL=newRegister.js.0eca3c8e481a65d417d2.hot-update.js.map