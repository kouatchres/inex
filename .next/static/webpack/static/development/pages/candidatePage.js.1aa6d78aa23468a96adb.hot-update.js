...
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:.5px solid ", ";grid-gap:5px;height:50;padding:5px;margin:3px 5px;& > *{background:#357;border:0;font-family:'radnika_next';font-size:1rem;padding:.9rem;}"], function (props) {
  return props.theme.lightGrey;
});
...
})(["background-color:#359;border-radius:5px;font-size:1.2rem;color:white;"]);
...
})(["color:white;background-color:#371;border-radius:5px;font-size:1.2rem;"]);
...
//# sourceMappingURL=candidatePage.js.1aa6d78aa23468a96adb.hot-update.js.map