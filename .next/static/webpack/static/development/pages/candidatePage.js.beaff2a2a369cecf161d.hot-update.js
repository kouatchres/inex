...
/* harmony import */ var _components_styles_Title__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/styles/Title */ "./src/components/styles/Title.js");
...
var ItemStyled = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].div.withConfig({
  displayName: "Candidate__ItemStyled",
  componentId: "sc-1vwlxkz-0"
})(["background:", ";border:.7px solid ", ";position:relative;display:grid;grid-template-columns:1fr;grid-auto-flow:colum;border-radius:18px;background-color:white;width:400px;height:300px;"], function (props) {
  return props.theme.darkGrey;
}, function (props) {
  return props.theme.lightGrey;
});
var CandAllInfo = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].div.withConfig({
  displayName: "Candidate__CandAllInfo",
  componentId: "sc-1vwlxkz-1"
})(["display:grid;grid-template-columns:repeat(2,1fr);height:250px;"]);
var ButtonList = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].div.withConfig({
  displayName: "Candidate__ButtonList",
  componentId: "sc-1vwlxkz-2"
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:3px solid ", ";grid-gap:3px;background:", ";height:60px;& > *{background:#357;border:0;font-family:'radnika_next';font-size:1.5rem;padding:.9rem;}"], function (props) {
  return props.theme.lightGrey;
}, function (props) {
  return props.theme.lightGrey;
});
var CandImg = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].div.withConfig({
  displayName: "Candidate__CandImg",
  componentId: "sc-1vwlxkz-3"
})(["width:200px;height:200px;img{max-width:100%;object-fit:cover;border-radius:12px;}"]);
var RestInfo = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].div.withConfig({
  displayName: "Candidate__RestInfo",
  componentId: "sc-1vwlxkz-4"
})(["display:flex;flex-direction:column;align-items:left;"]);
var UpdateBtn = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].div.withConfig({
  displayName: "Candidate__UpdateBtn",
  componentId: "sc-1vwlxkz-5"
})(["background-color:#359;"]);
var DelBtn = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].button.withConfig({
  ...
  _createClass(Candidate, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ItemStyled, {
        ...
        __self: this
      }, "First Name: ", cand1stName)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "itemInfo",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 100
        ...
        __self: this
      }, "Birth Place: ", placeOfBirth), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "itemInfo",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 114
        ...
        __self: this
      }, "Phone: ", phoneNumb))))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ButtonList, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 120
        },
...
//# sourceMappingURL=candidatePage.js.beaff2a2a369cecf161d.hot-update.js.map