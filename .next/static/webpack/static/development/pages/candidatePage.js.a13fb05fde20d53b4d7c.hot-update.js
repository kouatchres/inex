...
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:1px solid ", ";grid-gap:5px;height:20px;padding:15px;margin:15px 0;font-weight:bold;font-size:2.5rem;"], function (props) {
  return props.theme.lightGrey;
});
...
})(["background-color:#359;border-radius:10px;"]);
...
})(["background-color:#375;border-radius:10px;"]);
...
//# sourceMappingURL=candidatePage.js.a13fb05fde20d53b4d7c.hot-update.js.map