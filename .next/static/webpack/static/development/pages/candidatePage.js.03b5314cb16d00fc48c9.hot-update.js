...
})(["background:", ";border:.7px solid ", ";position:relative;display:grid;grid-template-columns:1fr;background-color:white;width:400px;border-radius:7px;height:320px;"], function (props) {
...
})(["display:grid;grid-template-columns:11fr 19fr;height:200px;"]);
...
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:1px solid ", ";grid-gap:5px;height:20px;padding:5px;margin:15px 0;"], function (props) {
  return props.theme.lightGrey;
});
...
})(["background-color:#359;border-radius:5px;font-size:2.5rem;font-weight:normal;color:white;"]);
...
})(["color:white;font-weight:bold;background-color:#375;border-radius:5px;font-size:2.5rem;"]);
...
//# sourceMappingURL=candidatePage.js.03b5314cb16d00fc48c9.hot-update.js.map