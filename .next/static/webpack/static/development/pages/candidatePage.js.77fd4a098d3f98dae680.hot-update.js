...
})(["background:", ";border:.7px solid ", ";position:relative;display:grid;grid-template-columns:1fr;background-color:white;width:410px;border-radius:7px;"], function (props) {
...
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:.5px solid ", ";grid-gap:5px;height:50;padding:5px;& > *{background:#357;border:0;font-family:'radnika_next';font-size:1rem;padding:.9rem;}"], function (props) {
  return props.theme.lightGrey;
});
...
})(["padding:5px;img{max-width:100%;object-fit:cover;border-radius:12px;width:200px;height:250px;}"]);
...
})(["display:flex;flex-direction:column;padding:5px;line-height:3px;"]);
...
})(["background-color:#359;border-radius:5px;font-size:2.2rem;font-weight:bold;color:white;"]);
...
})(["color:white;font-weight:bold;background-color:#371;border-radius:5px;font-size:2.2rem;"]);
  ...
  _createClass(Candidate, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ItemStyled, {
        ...
        __self: this
      }, "First Name: ", cand1stName)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ItemInfo, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 112
        },
        ...
        __self: this
      }, "Email: ", email)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ItemInfo, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 124
        },
...
})(["display:grid;grid-template-columns:repeat(auto-fit,minmax(410px,1fr));grid-gap:5px;min-width:300px;background:", ";width:100vw;margin:1px auto;max-width:", ";"], function (props) {
...
//# sourceMappingURL=candidatePage.js.77fd4a098d3f98dae680.hot-update.js.map