...
})(["background:", ";border:.7px solid ", ";position:relative;display:grid;grid-template-columns:1fr;background-color:white;width:400px;border-radius:7px;height:300px;"], function (props) {
...
})(["display:grid;grid-template-columns:repeat(2,1fr);width:100%;border-top:1px solid ", ";grid-gap:5px;height:50px;padding:5px;& > *{background:#357;border:0;font-family:'radnika_next';font-size:1.8rem;}"], function (props) {
  return props.theme.lightGrey;
});
...
//# sourceMappingURL=candidatePage.js.a95ca01a371f3f34a7b7.hot-update.js.map