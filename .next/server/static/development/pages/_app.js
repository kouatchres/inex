...
var Navbar = function Navbar() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_styles_NavStyles__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    __self: this
  }, "New Division")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_1___default.a, {
    href: "/CandDisplay",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8
    ...
    __self: this
  }, "Candidates")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_1___default.a, {
    href: "/newCand",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11
    ...
    __self: this
  }, "New Candidate")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_1___default.a, {
    href: "/newRegion",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14
    ...
    __self: this
  }, "New Region")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_1___default.a, {
    href: "/candidatePage",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17
    ...
    __self: this
  }, "Candidate")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_1___default.a, {
    href: "/regionPage",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20
...
})(["background:", ";color:black;"], function (props) {
...
var NavStyles = styled_components__WEBPACK_IMPORTED_MODULE_0___default.a.ul.withConfig({
  ...
  componentId: "pzr7e-0"
})(["margin:0;padding:0;display:flex;justify-self:end;font-size:1.5rem;a,button{padding:1rem .7rem;display:flex;align-items:center;position:relative;text-transform:lowercase;font-size:1em;background:none;border:0;cursor:pointer;color:", ";@media (max-width:700px){font-size:10px;padding:0 10px;}&:before{content:'';width:2px;background:", ";height:100%;left:0;position:absolute;transform:skew(-20deg);top:0;bottom:0;}&:after{height:2px;background:red;content:'';width:0;position:absolute;transform:translateX(-50%);transition:width 0.4s;transition-timing-function:cubic-bezier(1,-0.65,0,2.31);left:50%;margin-top:2rem;}&:hover,&:focus{outline:none;&:after{width:calc(100% - 20px);}}}@media (max-width:700px){border-top:1px solid ", ";width:100%;justify-content:center;font-size:3rem;}"], function (props) {
