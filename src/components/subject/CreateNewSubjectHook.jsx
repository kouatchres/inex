                            ...
                            <Form>
                                <AllControls>
                                    <InputGroup>
                                        ...
                                        <Select name="educType" onChange={(value) => (setFieldValue('educType', value))} options={getEducTypeOptions} placeholder={"Le Type d'Enseignement"} styles={customStyle} disabled={isSubmitting} />
                                        <Select name="subjectType" onChange={(value) => (setFieldValue('subjectType', value))} options={getSubjectTypeOptions} placeholder={"Le Type de Matière"} styles={customStyle} disabled={isSubmitting} />
