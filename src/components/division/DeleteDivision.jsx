...
import { ALL_DIVISIONS_QUERY } from '../division/Division'

const DELETE_DIVISION_QUERY = gql `
 mutation DELETE_DIVISION_QUERY($id: ID!){
...
// the deletedselect all the other DIVISIONs except the deleted one from the cache
