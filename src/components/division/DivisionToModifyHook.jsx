                ...
                <MinimStyledPage>
                    ...
                    <StyledForm disabled={isSubmitting} aria-busy={isSubmitting} >
                        <Form>
                            <TwoGroups>
                                <InputGroup>
                                    <Select name="regionID" onChange={handleReactSelectChange} options={getRegionsOptions} styles={customStyle} placeholder={"La Région"} />
                                    <Select name="divisionID" onChange={handleReactSelectChange} options={getDivisionOptions} styles={customStyle} placeholder={"La Département"} />
                                </InputGroup>
                                <Buttons>
                                    <ButtonStyled>
