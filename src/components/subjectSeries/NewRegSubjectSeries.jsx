                    ...
                    <MinimStyledPage>
                        ...
                        <StyledForm disabled={isSubmitting} aria-busy={isSubmitting} >
                            <Form>
                                <AllControls>
                                    <InputGroup>
                                        <Select onChange={handleReactSelectChange} name="educTypeID" styles={customStyle} placeholder="Le type d'enseignement" options={getEducTypeOptions} disbled={isSubmitting} />
                                        <Select onChange={(value) => (setFieldValue('series', value))} name="series" styles={customStyle} placeholder="La Série" options={getSeriesOptions} disbled={isSubmitting} />
                                        <Select onChange={(value) => (setFieldValue('subjectSeries', value))} name="subjectSeries" styles={customStyle} placeholder="La matière" options={getSubjectOptions} disbled={isSubmitting} />
