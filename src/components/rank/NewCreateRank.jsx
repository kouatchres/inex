...
class NewCreateRank extends Component {
    initialFormState = {
        rankName: '',
        rankCode: ''
    }
                        ...
                        <MinimStyledPage>
                            ...
                            <StyledForm>
                                <Form>
                                    <AllControls>
                                        <InputGroup>
                                            <SygexInput name="rankName" type="text" placeholder="Nom Poste" />
                                            <SygexInput name="rankCode" type="text" placeholder="Code Poste" />
