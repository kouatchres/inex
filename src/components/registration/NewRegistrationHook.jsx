                            ...
                            <Form>
                                <AllControls>
                                    <InputGroup>
                                        ...
                                        <Select onChange={handleReactSelectChange} name="sessionID" options={getSessionsOptions} styles={customStyle} placeholder={'La Session'} disabled={isSubmitting} />
                                        <Select onChange={handleReactSelectChange} name="examID" options={getExamsOptions} styles={customStyle} placeholder={"L'Examen"} disabled={isSubmitting} />
                                        <Select onChange={handleReactSelectChange} name="seriesID" options={getSeriesOptions} styles={customStyle} placeholder={'La Série'} disabled={isSubmitting} />
