                            ...
                            <Form>
                                <AllControls>
                                    <InputGroup>
                                        ...
                                        <Select onChange={handleReactSelectChange} name="regionID" placeholder="La Région" options={getRegionsOptions} styles={customStyle} />
                                        <Select name="division" onChange={value => setFieldValue('division', value)} label="" placeholder="Le Département" options={getRegionsOptions} styles={customStyle} />
