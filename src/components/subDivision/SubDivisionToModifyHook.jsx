                            ...
                            <Form>
                                <AllControls>
                                    <InputGroup>
                                        ...
                                        <Select onChange={handleReactSelectChange} name="subDivisionID" styles={customStyle} placeholder="L'Arrondissement" options={getSubDivOptions} disabled={isSubmitting} />
                                    </InputGroup>
                                    <Buttons>
                                        <ButtonStyled>
