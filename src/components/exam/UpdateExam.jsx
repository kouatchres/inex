...
const SINGLE_EXAM_QUERY = gql`
	query SINGLE_EXAM_QUERY($id: ID!) {
		exam(id: $id) {
			examName
			examCode
			id
...
const UPDATE_EXAM_MUTATION = gql`
	mutation UPDATE_EXAM_MUTATION($id: ID!, $examName: String, $examCode: String) {
		...
		return (
			...
			>
				{({ data, loading, error }) => {
					...
					return (
						<Mutation mutation={UPDATE_EXAM_MUTATION} variables={{ id: this.props.id }}>
