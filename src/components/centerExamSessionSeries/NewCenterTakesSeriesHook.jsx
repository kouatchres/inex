                            ...
                            <Form>
                                <AllControls>
                                    <InputGroup>
                                        ...
                                        <Select onChange={handleReactSelectChange} name="sessionID" styles={customStyle} options={getSessionOptions} placeholder={"La Session"} />
                                        <Select onChange={handleReactSelectChange} name="examID" styles={customStyle} options={getExamOptions} placeholder={"L'Examen"} />
                                        <Select onChange={handleReactSelectChange} name="educTypeID" styles={customStyle} options={getEducTypeOptions} placeholder={"Type d'Enseignement"} />
                                        <Select onChange={(value) => (setFieldValue('series', value))} name="series" styles={customStyle} options={getSeriesOptions} placeholder={"La Série"} />
                                    </InputGroup>
                                    <ButtonStyled>
