...
import DeleteDivision from "../division/DeleteDivision";
...
const GET_ALL_GENDER_QUERY = gql`
  query GET_ALL_GENDER_QUERY {
...
class SelectGenderToModify extends Component {
  ...
  render = () => {
    const { id } = this.state;
    return (
      <Query query={GET_ALL_GENDER_QUERY}>
        {({ data, loading, error }) => {
          {
            loading && <p>Loading...</p>;
          }
